...
import com.gt.model.Score;
import com.gt.observer.Observable;
import com.gt.observer.Observer;
...
public class Fenetre extends JFrame implements Observer{
	...
	private JMenuBar menu = null;
	  ...
	  File folder=new File (FileSystemView.getFileSystemView().getDefaultDirectory()+"/Pendu/");
	    ...
	    apropos2.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent e){
	    		JOptionPane.showMessageDialog(null,
							    		          "Créateur: Oumar\nLicense: Freeware\nCopyright: aob.diallo@gmail.com",
