...
public class NotGate extends InstanceFactory {
	...
	public static final AttributeOption SIZE_WIDE = new AttributeOption(Integer
			.valueOf(30), Strings.getter("gateSizeWideOpt"));
	...
	protected void configureNewInstance(Instance instance) {
		...
		configureLabel(instance, gateShape
				.equals(AppPreferences.SHAPE_RECTANGULAR), null);
	}
