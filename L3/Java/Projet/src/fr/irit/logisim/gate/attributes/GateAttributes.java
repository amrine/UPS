...
public class GateAttributes extends AbstractAttributeSet {
	...
	static final AttributeOption SIZE_NARROW = new AttributeOption(Integer
			.valueOf(30), Strings.getter("gateSizeNarrowOpt"));
	static final AttributeOption SIZE_MEDIUM = new AttributeOption(Integer
			.valueOf(50), Strings.getter("gateSizeNormalOpt"));
	static final AttributeOption SIZE_WIDE = new AttributeOption(Integer
			.valueOf(70), Strings.getter("gateSizeWideOpt"));
	...
	static final AttributeOption XOR_ONE = new AttributeOption("1", Strings
			.getter("xorBehaviorOne"));
	static final AttributeOption XOR_ODD = new AttributeOption("odd", Strings
			.getter("xorBehaviorOdd"));
	...
	public static final AttributeOption OUTPUT_01 = new AttributeOption("01", Strings
			.getter("gateOutput01"));
	public static final AttributeOption OUTPUT_0Z = new AttributeOption("0Z", Strings
			.getter("gateOutput0Z"));
	public static final AttributeOption OUTPUT_Z1 = new AttributeOption("Z1", Strings
			.getter("gateOutputZ1"));
	...
	public AttributeOption size = SIZE_MEDIUM;
	public int inputs = 5;
	...
	class GateAttributeList extends AbstractList<Attribute<?>> {
		private final Attribute<?>[] BASE_ATTRIBUTES = { StdAttr.FACING,
