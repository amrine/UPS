 ...
 * @author 21007631
 */
public class Rayon <P extends Produit>{
    ...
    public boolean isCategorieName(String categorieName){
        return rayonCategorie.getNom().equals(categorieName);
    }
    public String getCategorieRayon(){
        return rayonCategorie.getNom();
    }
